...
class DoubleDQN(object):
    ...
    def __init__(self, game_module=None, isTrain=False):
    ...
    def getAction(self):
        ...
        logging.info(f"Choose Action {action_index}")
    ...
    def start_train(self):
        ...
        do_nothing[0] = 1
        x_t, _, _ = self.game.intelligence(do_nothing)
        self.currentState = self.set_initial_state(x_t)
...
if __name__ == "__main__":
    ...
    dqn = DoubleDQN(game_module=Game, isTrain=False)
    dqn.start_train()
